<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="rep4.aspx.vb" Inherits="reportes.WebRepNeotel.rep4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="background-color: #428bca">
        <b>
            <asp:Label ID="lblTituloPrincipal" Text="Reporte - No es lo que parece" runat="server" Font-Size="Medium" ForeColor="White" /></b>
    </div>
