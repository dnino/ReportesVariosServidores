<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="rep1.aspx.vb" Inherits="reportes.WebRepNeotel.rep1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="background-color: #428bca">
        <b>
            <asp:Label ID="lblTituloPrincipal" Text="Reporte - Detalle de llamadas" runat="server" Font-Size="Medium" ForeColor="White" /></b>
    </div>
