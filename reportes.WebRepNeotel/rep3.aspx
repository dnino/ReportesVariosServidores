<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="rep3.aspx.vb" Inherits="reportes.WebRepNeotel.rep3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="background-color: #428bca">
        <b>
            <asp:Label ID="lblTituloPrincipal" Text="Reporte - Ventas agrupada Mes" runat="server" Font-Size="Medium" ForeColor="White" /></b>
    </div>
